...
const TINT_SHADOWS = {
  green: '0 0 8px rgba(0,196,125,0.08), 0 2px 10px rgba(0,196,125,0.12), inset 3px 3px 0.5px -3px rgba(0,196,125,0.2), inset -3px -3px 0.5px -3px rgba(0,196,125,0.15), inset 1px 1px 1px -0.5px rgba(0,196,125,0.35), inset -1px -1px 1px -0.5px rgba(0,196,125,0.35), inset 0 0 6px 6px rgba(0,196,125,0.1), inset 0 0 2px 2px rgba(0,196,125,0.06), 0 0 24px rgba(0,196,125,0.28)',
}

const TINT_OVERLAYS = {
  green: 'rgba(0,196,125,0.13)',
}

function LiquidButton({ className, variant, size, asChild = false, children, tint, ...props }) {
  const Comp = asChild ? Slot : "button"
      ...
      >
        {tint ? (
          <div
            ...
            style={{ boxShadow: TINT_SHADOWS[tint] }}
          />
        ) : (
        ...
        {tint && (
          <div
            className="absolute inset-0 rounded-full z-[1] pointer-events-none transition-all"
            style={{
              background: TINT_OVERLAYS[tint],
              border: '1px solid rgba(0,196,125,0.55)',
              boxShadow: 'inset 0 0 8px rgba(0,196,125,0.15)',
            }}
          />
        )}
        <div
...
const colorVariants = {
  ...
  gold: {
    outer: "bg-gradient-to-b from-[#c8841a] to-[#f0c040]",
    inner: "bg-gradient-to-b from-[#fff0a0] via-[#c8932a] to-[#ffd54f]",
    button: "bg-gradient-to-b from-[#ffe066] to-[#c8932a]",
    textColor: "text-[#FFFDE5]",
    textShadow: "[text-shadow:_0_-1px_0_rgb(200_132_26_/_100%)]",
  },
  bronze: {
